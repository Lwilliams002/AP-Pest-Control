    ...
    <div className="theme-miami min-h-screen bg-background text-foreground palm-bg">
      ...
      <main>
        <section className="relative">
          <img
            src={miamiImg}
            alt="Miami Art Deco hotel at sunset"
            width={1920}
            height={1024}
          ...
          <div className="absolute inset-x-0 bottom-0">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-12">
              <p className="text-xs uppercase tracking-[0.5em] text-secondary mb-4 font-semibold neon-cyan">
                South Florida · Coast to Coast
              </p>
              <h1 className="font-display text-6xl sm:text-8xl md:text-9xl font-bold tracking-wider uppercase">
                <span className="neon-cyan">South Florida</span>
                <br />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-10 items-start">
            <div>
              <p className="text-xs uppercase tracking-[0.4em] text-accent mb-3 font-semibold">
                From the 305 to the 561
              </p>
              <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold uppercase tracking-wide">
                Built for the <span className="text-gradient-miami">whole coast.</span>
              </h2>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {miamiCities.map((c) => (
                  <span
                    key={c}
                    className="text-xs px-3 py-1.5 border border-secondary/40 bg-card uppercase tracking-wider rounded-sm text-foreground/90"
                  >
                    {c}
                  </span>
                ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex items-end justify-between flex-wrap gap-3 mb-8">
              <div>
                ...
                <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold uppercase tracking-wide">
                  South Florida pest <span className="text-gradient-miami">programs.</span>
                </h2>
              </div>
              <p className="text-xs text-muted-foreground">
                {miamiPests.length} programs · 🌴 = South Florida exclusive
              </p>
            </div>
        ...
        <section
          id="miami-contact"
          className="py-16 md:py-20 border-t border-border bg-gradient-miami-sunset/10 scroll-mt-20"
        >
          <div className="max-w-6xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-10 items-start">
            <div>
              <p className="text-xs uppercase tracking-[0.4em] text-accent mb-3 font-semibold">
                Free South Florida estimate
              </p>
              <h2 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold uppercase tracking-wide">
                Tell us about <span className="text-gradient-miami">the pest.</span>
              </h2>
              <p className="mt-5 text-muted-foreground max-w-md">
                Miami to West Palm — we'll come out, look closer than anyone else has, and write a
...
const hotspotSlides: HotspotSlide[] = [
  {
    ...
    steps: [
      {
        label: "Inspect",
        body: "We walk the whole yard — gutters, bromeliads, AC pans, plant saucers, bird baths — and map every breeding site before we treat anything.",
      },
      {
        label: "Knock down",
        body: "Targeted fogging of foliage, hedges, and shaded harborage drops the adult population fast — usually noticeable by the next evening.",
      },
      {
        label: "Break the cycle",
        body: "Larvicide in standing water + monthly retreats during the wet season stop the next generation before it hatches.",
      },
    ],
    badges: [
      "Pet & kid conscious",
      "Event prep (24–48 hr)",
      "Monthly wet-season plans",
      "Rodent protection available",
    ],
  ...
  },
  {
    ...
    steps: [
      {
        label: "Inspect",
        body: "Flashlight inspection of every hinge, motor void, and appliance kick-plate to map the harborage before treatment.",
      },
      {
        label: "Gel & dust",
        body: "Precision gel baiting plus crack-and-crevice dust hits the colony where they hide — no kitchen-wide spray needed.",
      },
      {
        label: "Follow-up",
        body: "Two scheduled re-treats break the next two hatch cycles so a single egg case can't restart the infestation.",
      },
    ],
    badges: [
      "Discreet for kitchens",
      "Restaurant-ready protocols",
      "30-day knock-down guarantee",
  ...
  },
  {
    ...
    steps: [
      {
        label: "Identify",
        body: "We ID the species first — ghost vs. white-footed vs. big-headed — because each one needs a different bait matrix to actually work.",
      },
      {
        label: "Bait the colony",
        body: "Slow-acting baits ride back to the queens and satellite nests so the whole colony collapses, not just the workers you see.",
      },
      {
        label: "Seal the trail",
        body: "Perimeter treatment plus targeted exclusion around plumbing and electrical penetrations keeps new colonies from moving in.",
      },
    ],
    badges: [
      "Pet & kid conscious",
      "Kitchen-safe baits",
      "Ghost & white-footed specialists",
      "Quarterly perimeter plans",
    ],
