        ...
        <section className="relative">
          ...
          <div className="absolute inset-x-0 bottom-0">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-12 md:pb-20">
              <p className="text-xs uppercase tracking-[0.5em] text-brand-soft mb-5 font-semibold">Established 2012 · Family Owned</p>
              ...
              <p className="mt-6 text-base sm:text-lg text-foreground/85 max-w-xl leading-relaxed">
                Independent, family-run protection for homes and businesses across South Florida and the Arizona Valley. Sustainable methods, honest pricing, real people.
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a href="tel:+16028824013" className="px-7 py-3.5 border border-brand text-brand font-semibold uppercase tracking-widest text-xs rounded-sm hover:bg-brand/5 transition backdrop-blur-sm bg-background/30">
                  Call (602) 882-4013
                </a>
              </div>
            </div>
