  ...
  head: () => ({
    meta: [
      { title: "Contact AP Pest Control — Free Estimates Miami & Arizona" },
      {
        name: "description",
        content:
          "Request a free pest control estimate in Miami, FL or the Arizona Valley. Family owned, fast response, satisfaction guaranteed.",
      },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold">
              Free <span className="italic text-brand">estimate.</span>
            </h1>
            ...
            <p className="mt-5 text-base sm:text-lg text-muted-foreground max-w-md leading-relaxed">
              Tell us where the trouble is — Miami or the Valley — and we'll show up fast with a
              plan that actually works.
            </p>
            <div className="mt-8 space-y-4">
              <a
                href="tel:+16028824013"
                className="block p-5 border border-border rounded-sm hover:border-brand transition"
              >
                <p className="text-xs uppercase tracking-widest text-brand-soft font-semibold">
                  Phone
                </p>
                <p className="font-display text-2xl font-bold text-brand">(602) 882-4013</p>
              </a>
              <a
                href="mailto:hello@ap-pest-control.com"
                className="block p-5 border border-border rounded-sm hover:border-brand transition"
              >
                <p className="text-xs uppercase tracking-widest text-brand-soft font-semibold">
                  Email
                </p>
                <p className="font-display text-xl font-bold text-brand break-all">
