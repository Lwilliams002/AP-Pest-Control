...
const PEST_MOSQUITO: Pest = { t: "Mosquito Control", d: "Yard fogging and breeding-site treatment built for humid climates.", img: imgMosquito, about: "Aedes aegypti and Aedes albopictus are the dominant biters. Active dawn and dusk, breeding in any standing water — bottle caps to bromeliads.", signs: ["Itchy welts after being outside", "Buzzing around ankles", "Swarms near shaded, damp areas"], risk: "Vectors for Zika, dengue, West Nile, and chikungunya." };
