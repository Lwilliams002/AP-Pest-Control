...
export const miamiPests: Pest[] = [PEST_MOSQUITO, PEST_ANT, PEST_BEDBUG, PEST_BEE, PEST_COCKROACH, PEST_COMMERCIAL, PEST_EARWIG, PEST_FLEA, PEST_GENERAL, PEST_HORNET, PEST_IGUANA, PEST_NOSEEUM, PEST_RODENT, PEST_SILVERFISH, PEST_SPIDER, PEST_TERMITE, PEST_WASP, PEST_WHITEFLY, PEST_WILDLIFE];
