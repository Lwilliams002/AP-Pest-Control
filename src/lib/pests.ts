...
export const miamiPests: Pest[] = [PEST_ANT, PEST_BEDBUG, PEST_BEE, PEST_COCKROACH, PEST_COMMERCIAL, PEST_EARWIG, PEST_FLEA, PEST_GENERAL, PEST_HORNET, PEST_IGUANA, PEST_NOSEEUM, PEST_RODENT, PEST_SILVERFISH, PEST_SPIDER, PEST_TERMITE, PEST_WASP, PEST_WHITEFLY, PEST_WILDLIFE];
export const arizonaTermite: Pest = PEST_TERMITE;
export const arizonaPests: Pest[] = [PEST_ANT, PEST_BEDBUG, PEST_BEE, PEST_COCKROACH, PEST_COMMERCIAL, PEST_CRICKET, PEST_EARWIG, PEST_FLEA, PEST_GENERAL, PEST_HORNET, PEST_KISSINGBUG, PEST_PACKRAT, PEST_PIGEON, PEST_RATTLESNAKE, PEST_RODENT, PEST_SCORPION, PEST_SILVERFISH, PEST_SPIDER, PEST_WASP];
