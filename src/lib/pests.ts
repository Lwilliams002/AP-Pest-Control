...
const PEST_ANT: Pest = {
  ...
  img: imgAnt,
  about:
    "Multiple species form trails between food sources and hidden nests. Spraying the trail just splits the colony — baiting takes the whole thing out.",
  signs: [
    "Trails along countertops & baseboards",
    "Tiny piles of soil near cracks",
    "Ants swarming sweet or greasy spills",
  ],
...
const PEST_COCKROACH: Pest = {
  ...
  img: imgCockroach,
  about:
    "American roaches (large, reddish-brown) and German roaches (small, tan) are the two big offenders. Nocturnal, fast-breeding, drawn to moisture and food residue.",
  signs: [
    "Pepper-like droppings in drawers",
    "Musty odor in kitchens",
...
const PEST_COMMERCIAL: Pest = {
  ...
  img: imgCommercial,
  about:
    "Custom IPM programs for businesses with health-code obligations. Discreet uniforms, after-hours service, and full digital documentation for inspectors.",
  signs: [
    "Failed health inspection prep",
    "Guest or tenant complaints",
    "Recurring issues across units",
  ],
...
const PEST_EARWIG: Pest = {
  ...
  img: imgEarwig,
  about:
    "Dark, pincer-tailed insects that hide in damp mulch, leaf litter, and under pots. They wander indoors after heavy rain or irrigation.",
  signs: [
    "Pincer bugs in bathtubs and sinks",
    "Notched leaves on plants",
    "Activity under flowerpots and stones",
  ],
...
const PEST_FLEA: Pest = {
  ...
  img: imgFlea,
  about:
    "Tiny jumping parasites that ride in on pets and wildlife. Eggs and larvae live in carpet, bedding, and shaded yard areas — adults are only 5% of the population.",
  signs: [
    "Itchy red bites around ankles",
    "Pets scratching constantly",
    "Black 'pepper' specks in pet bedding",
  ],
...
const PEST_GENERAL: Pest = {
  ...
  img: imgGeneral,
  about:
    "An all-in-one perimeter program for the everyday stuff — ants, spiders, crickets, silverfish, earwigs, occasional invaders. Family- and pet-conscious products.",
  signs: [
    "Spotting bugs more than once a month",
    "Webs around eaves and corners",
    "Activity along baseboards",
  ],
...
const PEST_HORNET: Pest = {
  ...
  img: imgHornet,
  about:
    "Large, aggressive social wasps that build paper nests in trees, sheds, and attics. Defend the nest with repeated stings.",
  signs: [
    "Football-shaped paper nests",
    "Hornets patrolling a single area",
...
const PEST_RODENT: Pest = {
  ...
  img: imgRodent,
  about:
    "Roof rats, Norway rats, and house mice chew through wire, insulation, and food packaging — and reproduce shockingly fast.",
  signs: [
    "Scratching in walls or ceilings at night",
    "Dark, rice-shaped droppings",
...
const PEST_SCORPION: Pest = {
  ...
  img: imgScorpion,
  about:
    "Bark scorpions (Centruroides sculpturatus) are Arizona's most venomous — pale tan, 2–3\", the only species that climbs walls and ceilings. Glow green under UV.",
  signs: [
    "Glowing under blacklight at night",
    "Sightings in showers, shoes, or laundry",
    "Found in block walls or wood piles",
  ],
...
const PEST_SILVERFISH: Pest = {
  ...
  img: imgSilverfish,
  about:
    "Teardrop-shaped, silvery, fast-moving insects that thrive in humid, dark spaces. They feed on paper, glue, starches, and fabric.",
  signs: [
    "Yellow stains on paper or books",
    "Tiny holes in stored clothing",
...
const PEST_SPIDER: Pest = {
  ...
  img: imgSpider,
  about:
    "Black widows and brown spiders hide in block walls, garages, and patio furniture. Most other spiders are harmless — but webs and egg sacs multiply fast.",
  signs: [
    "Tangled webs under patio furniture",
    "Egg sacs in garage corners",
    "Spiders in shoes or stored boxes",
  ],
...
const PEST_WASP: Pest = {
  ...
  img: imgWasp,
  about:
    "Paper wasps and yellowjackets build umbrella-shaped nests under overhangs. Aggressive when disturbed — yellowjackets can sting repeatedly.",
  signs: [
    "Wasps entering a small hole in siding",
    "Open-comb nests under eaves",
    "Increased activity around trash cans",
  ],
...
const PEST_MOSQUITO: Pest = {
  ...
  img: imgMosquito,
  about:
    "Aedes aegypti and Aedes albopictus are the dominant biters. Active dawn and dusk, breeding in any standing water — bottle caps to bromeliads.",
  signs: [
    "Itchy welts after being outside",
    "Buzzing around ankles",
    "Swarms near shaded, damp areas",
  ],
...
const PEST_TERMITE: Pest = {
  ...
  img: imgTermite,
  about:
    "Subterranean termites (incl. invasive Formosan) tunnel up from soil; drywood termites live entirely inside wood. Damage is rarely covered by insurance.",
  signs: [
...
const PEST_BEE: Pest = {
  ...
  img: imgBee,
  about:
    "Honey bees and Africanized hybrids nest in walls, attics, irrigation boxes, and trees. Africanized colonies defend aggressively in massive swarms.",
  signs: [
    "Bees entering a single hole in siding",
...
const PEST_NOSEEUM: Pest = {
  ...
  img: imgNoseeum,
  about:
    "Tiny biting midges nearly invisible to the naked eye — punch through standard window screens. Brutal at dusk near the coast and Intracoastal.",
  signs: [
    "Itchy welts with no visible bug",
    "Worse at dawn and dusk",
    "Activity near brackish water",
  ],
...
const PEST_WHITEFLY: Pest = {
  ...
  img: imgWhitefly,
  about:
    "Tiny white flying insects that suck sap from ornamentals. Ficus whitefly has devastated South Florida hedges and high-end landscaping.",
  signs: [
    "Sticky honeydew on cars and patios",
    "Black sooty mold on leaves",
    "Defoliating ficus hedges",
  ],
...
const PEST_WILDLIFE: Pest = {
  ...
  img: imgWildlife,
  about:
    "Attic and soffit intruders that tear insulation, contaminate ducts, and bring in fleas and ticks. Common in older Miami neighborhoods with mature canopy.",
  signs: [
    "Heavy thumping in the attic at night",
    "Torn soffit vents or roof returns",
    "Droppings in the attic or under decks",
  ],
...
const PEST_KISSINGBUG: Pest = {
  ...
  img: imgKissingbug,
  about:
    "Sonoran Desert conenose bugs feed on blood at night and are drawn to packrat nests, kennels, and outdoor lights. Active during monsoon nights.",
  signs: [
...
const PEST_CRICKET: Pest = {
  ...
  img: imgCricket,
  about:
    "Field crickets swarm Valley homes during monsoon — drawn to outdoor lights, they pile up at doorways and slip into garages and laundry rooms by the dozen.",
  signs: [
    "Loud chirping at night",
    "Crickets piled at exterior lights",
    "Activity in garages after storms",
  ],
...
export const testimonials = [
  {
    ...
    city: "Scottsdale, AZ",
    quote:
      "Absolute pleasure working with AP Pest. My area was a bit out of their service area but they said no worries — and that they did.",
  },
  {
    name: "Tasia McWilliams",
    city: "Scottsdale, AZ",
    quote:
      "Matt paid close attention to detail, especially around entry points I didn't even know existed. Thoughtful about our 1-year-old.",
  },
  {
    name: "Brittany David",
    city: "Phoenix, AZ",
    quote:
      "Their team is extremely knowledgeable, reliable, and will make sure your pest and rodent problems are quickly handled.",
  },
];
